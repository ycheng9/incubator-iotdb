...
public class QueryDataFromUnclosedTsFileIT {
  ...
  @Before
  public void setUp() {
    bufferWriteFileSize = IoTDBDescriptor.getInstance().getConfig().bufferwriteFileSizeThreshold;
    IoTDBDescriptor.getInstance().getConfig().bufferwriteFileSizeThreshold = 100;
